% https://www.overleaf.com/project/6849d40317befa12db071c8a
...
\begin{document}
    ...
    \begin{header}
        ...
        \vspace{5 pt}
        \fontsize{14 pt}{14 pt}\selectfont Backend Engineer (Node.js, MongoDB, MySQL, Kafka, MCP Server)
    ...
    \section{Summary}
        ...
        Results-oriented Senior Backend Engineer with over 6 years of experience building scalable, high-performance systems using \textbf{Node.js, Express.js, MongoDB, Kafka, and Docker}. Proven expertise in breaking down complex business requirements into backend solutions, developing robust RESTful APIs, implementing secure authentication mechanisms (\textbf{JWT/OAuth2}), and optimizing data pipelines for performance. Spearheaded large-scale migrations, improved API throughput by up to 40\%, and managed production systems serving millions of users. Skilled in \textbf{CI/CD}, infrastructure monitoring, and microservice architectures, with a passion for clean code and scalable system design.
  \vspace{0.2 cm}
    ...
    \section{Experience}
        ...
        \begin{onecolentry}
            \begin{highlights}
                ...
                % \item Engineered Shopify integrations for 1K+ vendors, improving sync and fulfillment speed by 80\%.
            \end{highlights}
        \end{onecolentry}
